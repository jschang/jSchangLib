...
public interface ExchangeContext {
	...
	/**
	 * each exchange may have a different business calendar
	 * so we get a new instance to that here
	 * 
	 * @param mc
	 * @return
	 */
	...
	void setBusinessCalendar(BusinessCalendar calendar);
	
	BusinessCalendar cloneBusinessCalendar();
