...
public class SimulatedPlatformTest {
	...
	@Test public void testMarketBuySell() throws Exception {
		...
		Assert.assertEquals(25.55, position.getBasisCost(), TOL );
		Assert.assertEquals(100.0, position.getQuantity(), TOL );
		// (25.41*100)+(27.29*100)=5270
		Assert.assertEquals(5273.0, account.getEquity(), TOL );
		// 7210.05-(25.55*100)-4.95=4650.10
		Assert.assertEquals(4650.1, account.getBuyingPower(), TOL );
		...
		Assert.assertEquals(3910.0, account.getEquity(), TOL);
		// 4650.10+(50*27.13)-4.95=6001.65
		Assert.assertEquals(6001.65, account.getBuyingPower(), TOL);
		...
		Assert.assertEquals(27.7, position.getBasisCost(), TOL);
		Assert.assertEquals(75.0, position.getQuantity(), TOL);
		// (75*27.4)+(100*25.38)=3910.0
		Assert.assertEquals(4498.0, account.getEquity(), TOL);
